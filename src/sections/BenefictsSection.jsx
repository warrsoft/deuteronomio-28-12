...
export default function BenefictsSection () {
    return (
        <section className="bg-light p-4 pt-8 flex flex-col gap-8 justify-center items-center">
            <header className="flex flex-col items-center justify-center w-full text-center gap-4">
                <h2 className="font-bold text-2xl">Lo natural que tu cabello estaba esperando</h2>
